...
PHP_METHOD(Tensor_Vector, median)
{
	...
	if (UNEXPECTED(ZEPHIR_LT_LONG(&_0, 1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 2, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "tensor/vector.zep", 1231);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&result);
...
PHP_METHOD(Tensor_Vector, quantile)
{
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "tensor/vector.zep", 1250);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (UNEXPECTED(ZEPHIR_LT_LONG(&_5, 1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_6$$4, "tensor/vector.zep", 1255);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&result);
...
PHP_METHOD(Tensor_Vector, variance)
{
	...
	if (!(Z_TYPE_P(mean) == IS_NULL)) {
		...
		if (UNEXPECTED(!zephir_is_true(&_0$$3))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_1$$4, "tensor/vector.zep", 1275);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} else {
...
PHP_METHOD(Tensor_Vector, round)
{
	...
	if (UNEXPECTED(precision < 0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 2, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/vector.zep", 1299);
		ZEPHIR_MM_RESTORE();
		return;
	}
	object_init_ex(return_value, zend_get_called_scope(execute_data));
...
PHP_METHOD(Tensor_Vector, multiplyMatrix)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *b, b_sub, _0, _1, aHat, bHat, result, _8, _9, _10, _2$$3, _3$$3, _5$$3;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_METHOD(&aHat, this_ptr, "asTensorBuffer", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&bHat, b, "asTensorBuffer", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_multiply_row(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 14, &result, &_9, &_10);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Vector, divideMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_divide_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, addMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_add_row(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, subtractMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_subtract_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, powMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_pow_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, modMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_mod_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, equalMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_equal_row(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, notEqualMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_not_equal_row(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, greaterMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_greater_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, greaterEqualMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_greater_equal_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, lessMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_less_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, lessEqualMatrix)
{
	...
	ZEPHIR_INIT_VAR(&result);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 2, PH_NOISY_CC | PH_READONLY);
	tensor_less_equal_row_reverse(&result, &bHat, &aHat, &_8);
	object_init_ex(return_value, tensor_matrix_ce);
	ZEPHIR_CALL_METHOD(&_9, b, "m", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, b, "n", NULL, 0);
...
PHP_METHOD(Tensor_Vector, offsetSet)
{
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(tensor_exceptions_runtimeexception_ce, "Vector cannot be mutated directly.", "tensor/vector.zep", 2066);
	return;
}
...
PHP_METHOD(Tensor_Vector, offsetUnset)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(1, 0, &index);
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(tensor_exceptions_runtimeexception_ce, "Vector cannot be mutated directly.", "tensor/vector.zep", 2090);
	return;
}
...
PHP_METHOD(Tensor_Vector, offsetGet)
{
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "tensor/vector.zep", 2104);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Tensor_Vector, __unserialize)
{
	...
	zephir_array_fetch_string(&_0, &data, SL("data"), PH_NOISY | PH_READONLY, "tensor/vector.zep", 2145);
	ZVAL_BOOL(&_1, 0);
	...
	zephir_array_fetch_string(&_2, &data, SL("n"), PH_NOISY | PH_READONLY, "tensor/vector.zep", 2148);
