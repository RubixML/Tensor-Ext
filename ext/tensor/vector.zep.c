 ...
 * @return self
 */
PHP_METHOD(Tensor_Vector, fromTensorBuffer)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *a, a_sub, _0;
...
PHP_METHOD(Tensor_Vector, fill)
{
	...
	if (UNEXPECTED(_1)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$3, "tensor/vector.zep", 103);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(n < 1)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_8$$4, "tensor/vector.zep", 108);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZVAL_LONG(&_2, 0);
...
PHP_METHOD(Tensor_Vector, rand)
{
	...
	while (1) {
		...
		zephir_array_append(&a, &_7$$4, PH_SEPARATE, "tensor/vector.zep", 133);
	}
...
PHP_METHOD(Tensor_Vector, gaussian)
{
	...
	if (UNEXPECTED(n < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 3, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/vector.zep", 151);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&a);
	...
	while (1) {
		...
		zephir_array_append(&a, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 165);
		ZVAL_DOUBLE(&_13$$4, phi);
		ZEPHIR_INIT_NVAR(&_12$$4);
		ZVAL_DOUBLE(&_12$$4, (r * cos(phi)));
		zephir_array_append(&a, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 166);
	}
	if (zephir_fast_count_int(&a) > n) {
		ZEPHIR_MAKE_REF(&a);
...
PHP_METHOD(Tensor_Vector, poisson)
{
	...
	if (UNEXPECTED(n < 1)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/vector.zep", 188);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(lambda < 0.0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "tensor/vector.zep", 193);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (lambda == 0.0) {
	...
	while (1) {
		...
		zephir_array_append(&a, &_16$$6, PH_SEPARATE, "tensor/vector.zep", 218);
	}
	ZEPHIR_RETURN_CALL_STATIC("quick", NULL, 0, &a);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Tensor_Vector, uniform)
{
	...
	if (UNEXPECTED(n < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 3, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/vector.zep", 235);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&a);
	...
	while (1) {
		...
		zephir_array_append(&a, &_9$$4, PH_SEPARATE, "tensor/vector.zep", 243);
	}
	ZEPHIR_RETURN_CALL_STATIC("quick", NULL, 0, &a);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Tensor_Vector, linspace)
{
	...
	if (UNEXPECTED(min > max)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(tensor_exceptions_invalidargumentexception_ce, "Minimum must be less than maximum.", "tensor/vector.zep", 274);
		return;
	}
	if (UNEXPECTED(n < 2)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$4, "tensor/vector.zep", 279);
		ZEPHIR_MM_RESTORE();
		return;
	}
	k = (n - 1);
	...
	while (1) {
		...
		zephir_array_append(&a, &_9$$5, PH_SEPARATE, "tensor/vector.zep", 289);
	}
	ZEPHIR_INIT_NVAR(&_6);
	ZVAL_DOUBLE(&_6, max);
	zephir_array_append(&a, &_6, PH_SEPARATE, "tensor/vector.zep", 292);
...
PHP_METHOD(Tensor_Vector, __construct)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool validate;
	zval *a = NULL, a_sub, *validate_param = NULL, buffer, _2, _3, _0$$4;
	...
	if (Z_TYPE_P(a) == IS_ARRAY) {
		...
		tensor_buffer_from_array(&buffer, a);
		ZEPHIR_INIT_NVAR(a);
		object_init_ex(a, tensor_tensorbuffer_ce);
		ZEPHIR_CALL_METHOD(NULL, a, "__construct", NULL, 14, &buffer);
		zephir_check_call_status();
	} else if (!(zephir_instance_of_ev(a, tensor_tensorbuffer_ce))) {
		ZEPHIR_INIT_VAR(&_0$$4);
		object_init_ex(&_0$$4, tensor_exceptions_invalidargumentexception_ce);
		ZEPHIR_INIT_VAR(&_1$$4);
		ZEPHIR_CONCAT_SS(&_1$$4, "Vector requires", " an array or TensorBuffer object.");
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 3, &_1$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$4, "tensor/vector.zep", 311);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Tensor_Vector, asColumnMatrix)
{
	zend_bool _6;
	zval b, _4$$3, _7$$4;
	zval valueA, aHat, _0, *_1, _2, *_3, _5;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&aHat, &_0, "toArray", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&b);
	array_init(&b);
	if (Z_TYPE_P(&aHat) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_2);
		zephir_string_to_char_array(&_2, &aHat);
		_1 = &_2;
	} else {
		_1 = &aHat;
	}
	zephir_is_iterable(_1, 0, "tensor/vector.zep", 415);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_1), _3)
		{
			...
			zephir_array_append(&b, &_4$$3, PH_SEPARATE, "tensor/vector.zep", 412);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&b, &_7$$4, PH_SEPARATE, "tensor/vector.zep", 412);
		}
	}
	ZEPHIR_INIT_NVAR(&valueA);
...
PHP_METHOD(Tensor_Vector, reshape)
{
	...
	zend_bool _0;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval *m_param = NULL, *n_param = NULL, _3, _1$$3, _4$$4, _5$$4, _6$$4, _7$$4, _8$$6, _9$$6, _10$$6;
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "tensor/vector.zep", 430);
		ZEPHIR_MM_RESTORE();
		return;
	}
	nHat = (m * n);
	...
	if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&_3, nHat))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$4, "tensor/vector.zep", 437);
		ZEPHIR_MM_RESTORE();
		return;
	}
	i = 0;
...
PHP_METHOD(Tensor_Vector, transpose)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_columnvector_ce, "fromTensorBuffer", NULL, 0, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Vector, map)
{
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_STATIC("quick", NULL, 0, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Vector, dot)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/vector.zep", 509);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Tensor_Vector, convolve)
{
	...
	if (UNEXPECTED(ZEPHIR_GT(&_0, &_1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/vector.zep", 527);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(stride < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 3, &_7$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$4, "tensor/vector.zep", 532);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_8);
	...
	ZEPHIR_RETURN_CALL_STATIC("fromTensorBuffer", NULL, 0, &_8);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Vector, outer)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *b, b_sub, j, valueA, valueB, aHat, _0, _1, *_3, _4, *_5, _10, *_6$$3, _9$$4, *_12$$5, _15$$6;
	zval *this_ptr = getThis();
	...
	array_init(&rowC);
	ZEPHIR_CALL_METHOD(&_1, b, "asArray", NULL, 0);
	zephir_check_call_status();
	zephir_get_arrval(&_2, &_1);
	ZEPHIR_CPY_WRT(&bHat, &_2);
	if (Z_TYPE_P(&aHat) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_4);
		zephir_string_to_char_array(&_4, &aHat);
		_3 = &_4;
	} else {
		_3 = &aHat;
	}
	zephir_is_iterable(_3, 0, "tensor/vector.zep", 588);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&bHat), _7$$3, _8$$3, _6$$3)
			{
				...
				zephir_array_append(&rowC, &_9$$4, PH_SEPARATE, "tensor/vector.zep", 582);
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&valueB);
			ZEPHIR_INIT_NVAR(&j);
			zephir_array_append(&c, &rowC, PH_SEPARATE, "tensor/vector.zep", 585);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&bHat), _13$$5, _14$$5, _12$$5)
				{
					...
					zephir_array_append(&rowC, &_15$$6, PH_SEPARATE, "tensor/vector.zep", 582);
				} ZEND_HASH_FOREACH_END();
				ZEPHIR_INIT_NVAR(&valueB);
				ZEPHIR_INIT_NVAR(&j);
				zephir_array_append(&c, &rowC, PH_SEPARATE, "tensor/vector.zep", 585);
...
PHP_METHOD(Tensor_Vector, pNorm)
{
	...
	if (UNEXPECTED(p <= 0.0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 3, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/vector.zep", 622);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Tensor_Vector, multiply)
{
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/vector.zep", 665);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Vector, divide)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/vector.zep", 695);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Vector, add)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/vector.zep", 726);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Vector, log)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *base_param = NULL, _0$$3, valueA, a, _1, *_2, _3, *_4, _8, _5$$4, _6$$4, _10$$5, _11$$5;
	double base;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&a) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_3);
		zephir_string_to_char_array(&_3, &a);
		_2 = &_3;
	} else {
		_2 = &a;
	}
	zephir_is_iterable(_2, 0, "tensor/vector.zep", 1091);
	if (Z_TYPE_P(_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_2), _4)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_6$$4, PH_SEPARATE, "tensor/vector.zep", 1088);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_11$$5, PH_SEPARATE, "tensor/vector.zep", 1088);
		}
	}
	ZEPHIR_INIT_NVAR(&valueA);
...
PHP_METHOD(Tensor_Vector, product)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_METHOD(&_0, "product", NULL, 0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Vector, min)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_METHOD(&_0, "min", NULL, 0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Vector, median)
{
	...
	if (zephir_safe_mod_zval_long(&_3, 2) == 1) {
		...
		zephir_array_fetch_long(&median, &a, mid, PH_NOISY, "tensor/vector.zep", 1250);
	} else {
		zephir_memory_observe(&_4$$4);
		zephir_array_fetch_long(&_4$$4, &a, (mid - 1), PH_NOISY, "tensor/vector.zep", 1252);
		zephir_memory_observe(&_5$$4);
		zephir_array_fetch_long(&_5$$4, &a, mid, PH_NOISY, "tensor/vector.zep", 1252);
...
PHP_METHOD(Tensor_Vector, quantile)
{
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "tensor/vector.zep", 1269);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (ZEPHIR_LE_LONG(&_7, xHat)) {
		...
		zephir_array_fetch_long(&_8$$4, &a, (zephir_get_numberval(&_9$$4) - 1), PH_NOISY, "tensor/vector.zep", 1281);
		RETURN_MM_DOUBLE(zephir_get_doubleval(&_8$$4));
	}
	remainder =  ((x -  (double) xHat));
	zephir_memory_observe(&_10);
	zephir_array_fetch_long(&_10, &a, (xHat - 1), PH_NOISY, "tensor/vector.zep", 1286);
	t =  (zephir_get_doubleval(&_10));
	zephir_memory_observe(&_11);
	zephir_array_fetch_long(&_11, &a, xHat, PH_NOISY, "tensor/vector.zep", 1288);
...
PHP_METHOD(Tensor_Vector, variance)
{
	...
	if (!(Z_TYPE_P(mean) == IS_NULL)) {
		...
		if (UNEXPECTED(!zephir_is_true(&_0$$3))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_1$$4, "tensor/vector.zep", 1303);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} else {
...
PHP_METHOD(Tensor_Vector, round)
{
	...
	zval b;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval *precision_param = NULL, _0$$3, _1$$4, _2$$4, _3$$4, _4$$4, valueA, a, _5, *_6, _7, *_8, _11, _9$$5, _10$$5, _13$$6, _14$$6;
	...
	if (UNEXPECTED(precision < 0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "tensor/vector.zep", 1331);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&b);
	...
	if (Z_TYPE_P(&a) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_7);
		zephir_string_to_char_array(&_7, &a);
		_6 = &_7;
	} else {
		_6 = &a;
	}
	zephir_is_iterable(_6, 0, "tensor/vector.zep", 1344);
	if (Z_TYPE_P(_6) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_6), _8)
		{
			...
			zephir_array_append(&b, &_9$$5, PH_SEPARATE, "tensor/vector.zep", 1341);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&b, &_13$$6, PH_SEPARATE, "tensor/vector.zep", 1341);
		}
	}
	ZEPHIR_INIT_NVAR(&valueA);
	ZEPHIR_RETURN_CALL_STATIC("quick", NULL, 0, &b);
...
PHP_METHOD(Tensor_Vector, clip)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *min_param = NULL, *max_param = NULL, _0$$3, valueA, a, _2, *_3, _4, *_5, _8, _6$$5, _7$$6, _10$$8, _11$$9;
	double min, max;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(min > max)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/vector.zep", 1380);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&b);
	array_init(&b);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&a, &_2, "toArray", NULL, 0);
	zephir_check_call_status();
	if (Z_TYPE_P(&a) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_4);
		zephir_string_to_char_array(&_4, &a);
		_3 = &_4;
	} else {
		_3 = &a;
	}
	zephir_is_iterable(_3, 0, "tensor/vector.zep", 1405);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&valueA);
			...
			if (ZEPHIR_GT_DOUBLE(&valueA, max)) {
				...
				zephir_array_append(&b, &_6$$5, PH_SEPARATE, "tensor/vector.zep", 1391);
				continue;
			}
			if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
				ZEPHIR_INIT_NVAR(&_7$$6);
				ZVAL_DOUBLE(&_7$$6, min);
				zephir_array_append(&b, &_7$$6, PH_SEPARATE, "tensor/vector.zep", 1397);
				continue;
			}
			zephir_array_append(&b, &valueA, PH_SEPARATE, "tensor/vector.zep", 1402);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (ZEPHIR_GT_DOUBLE(&valueA, max)) {
					...
					zephir_array_append(&b, &_10$$8, PH_SEPARATE, "tensor/vector.zep", 1391);
					continue;
				}
				if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
					ZEPHIR_INIT_NVAR(&_11$$9);
					ZVAL_DOUBLE(&_11$$9, min);
					zephir_array_append(&b, &_11$$9, PH_SEPARATE, "tensor/vector.zep", 1397);
					continue;
				}
				zephir_array_append(&b, &valueA, PH_SEPARATE, "tensor/vector.zep", 1402);
		}
...
PHP_METHOD(Tensor_Vector, clipLower)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *min_param = NULL, valueA, a, _0, *_1, _2, *_3, _5, _4$$4, _7$$6;
	double min;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_1, 0, "tensor/vector.zep", 1432);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_1), _3)
		{
			ZEPHIR_INIT_NVAR(&valueA);
			...
			if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
				...
				zephir_array_append(&b, &_4$$4, PH_SEPARATE, "tensor/vector.zep", 1424);
				continue;
			}
			zephir_array_append(&b, &valueA, PH_SEPARATE, "tensor/vector.zep", 1429);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _1, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
					ZEPHIR_INIT_NVAR(&_7$$6);
					ZVAL_DOUBLE(&_7$$6, min);
					zephir_array_append(&b, &_7$$6, PH_SEPARATE, "tensor/vector.zep", 1424);
					continue;
				}
				zephir_array_append(&b, &valueA, PH_SEPARATE, "tensor/vector.zep", 1429);
		}
...
PHP_METHOD(Tensor_Vector, clipUpper)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *max_param = NULL, valueA, a, _0, *_1, _2, *_3, _5, _4$$4, _7$$6;
	double max;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_1, 0, "tensor/vector.zep", 1459);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_1), _3)
		{
			ZEPHIR_INIT_NVAR(&valueA);
			...
			if (ZEPHIR_GT_DOUBLE(&valueA, max)) {
				...
				zephir_array_append(&b, &_4$$4, PH_SEPARATE, "tensor/vector.zep", 1451);
				continue;
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				if (ZEPHIR_GT_DOUBLE(&valueA, max)) {
					...
					zephir_array_append(&b, &_7$$6, PH_SEPARATE, "tensor/vector.zep", 1451);
					continue;
				}
				zephir_array_append(&b, &valueA, PH_SEPARATE, "tensor/vector.zep", 1456);
		}
...
PHP_METHOD(Tensor_Vector, sign)
{
	zend_bool _8;
	zval b;
	zval valueA, a, _0, *_1, _2, *_3, _7, _4$$4, _5$$5, _6$$6, _9$$8, _10$$9, _11$$10;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_1, 0, "tensor/vector.zep", 1485);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_1), _3)
		{
			ZEPHIR_INIT_NVAR(&valueA);
			...
			if (ZEPHIR_GT_LONG(&valueA, 0)) {
				...
				zephir_array_append(&b, &_4$$4, PH_SEPARATE, "tensor/vector.zep", 1477);
			} else if (ZEPHIR_LT_LONG(&valueA, 0)) {
				ZEPHIR_INIT_NVAR(&_5$$5);
				ZVAL_DOUBLE(&_5$$5, -1.0);
				zephir_array_append(&b, &_5$$5, PH_SEPARATE, "tensor/vector.zep", 1479);
			} else {
				ZEPHIR_INIT_NVAR(&_6$$6);
				ZVAL_DOUBLE(&_6$$6, 0.0);
				zephir_array_append(&b, &_6$$6, PH_SEPARATE, "tensor/vector.zep", 1481);
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _1, "rewind", NULL, 0);
		...
		while (1) {
			...
			zephir_check_call_status();
				if (ZEPHIR_GT_LONG(&valueA, 0)) {
					...
					zephir_array_append(&b, &_9$$8, PH_SEPARATE, "tensor/vector.zep", 1477);
				} else if (ZEPHIR_LT_LONG(&valueA, 0)) {
					ZEPHIR_INIT_NVAR(&_10$$9);
					ZVAL_DOUBLE(&_10$$9, -1.0);
					zephir_array_append(&b, &_10$$9, PH_SEPARATE, "tensor/vector.zep", 1479);
				} else {
					ZEPHIR_INIT_NVAR(&_11$$10);
					ZVAL_DOUBLE(&_11$$10, 0.0);
					zephir_array_append(&b, &_11$$10, PH_SEPARATE, "tensor/vector.zep", 1481);
				}
		}
	}
	ZEPHIR_INIT_NVAR(&valueA);
...
PHP_METHOD(Tensor_Vector, negate)
{
	...
	zephir_is_iterable(_1, 0, "tensor/vector.zep", 1505);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_1), _3)
		{
			ZEPHIR_INIT_NVAR(&valueA);
			...
			zephir_array_append(&b, &valueA, PH_SEPARATE, "tensor/vector.zep", 1502);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _1, "rewind", NULL, 0);
		zephir_check_call_status();
...
PHP_METHOD(Tensor_Vector, multiplyMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1531);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1528);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1528);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, divideMatrix)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 3, &_7$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/vector.zep", 1546);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&c);
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1557);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1554);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1554);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, addMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1583);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1580);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1580);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, subtractMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1609);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1606);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1606);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
	...
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1632);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, modMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1661);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1658);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1658);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, equalMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1687);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1684);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1684);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, notEqualMatrix)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 3, &_7$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/vector.zep", 1702);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&c);
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1713);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1710);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1710);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, greaterMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1739);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1736);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1736);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, greaterEqualMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1765);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1762);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1762);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, lessMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1791);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1788);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1788);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, lessEqualMatrix)
{
	...
	zephir_is_iterable(_9, 0, "tensor/vector.zep", 1817);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			ZEPHIR_INIT_NVAR(&rowB);
			...
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/vector.zep", 1814);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&c, &_16$$5, PH_SEPARATE, "tensor/vector.zep", 1814);
		}
	}
	ZEPHIR_INIT_NVAR(&rowB);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_matrix_ce, "quick", NULL, 0, &c);
...
PHP_METHOD(Tensor_Vector, multiplyVector)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 3, &_7$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/vector.zep", 1832);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_8);
...
PHP_METHOD(Tensor_Vector, multiplyScalar)
{
	...
	ZEPHIR_RETURN_CALL_STATIC("fromTensorBuffer", NULL, 0, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Vector, offsetSet)
{
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(tensor_exceptions_runtimeexception_ce, "Vector cannot be mutated directly.", "tensor/vector.zep", 2188);
	return;
}
...
PHP_METHOD(Tensor_Vector, offsetUnset)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(1, 0, &index);
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(tensor_exceptions_runtimeexception_ce, "Vector cannot be mutated directly.", "tensor/vector.zep", 2212);
	return;
}
...
PHP_METHOD(Tensor_Vector, offsetGet)
{
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "tensor/vector.zep", 2226);
		ZEPHIR_MM_RESTORE();
		return;
	}
