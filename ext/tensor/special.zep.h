...
ZEND_BEGIN_ARG_INFO_EX(arginfo_tensor_special_argmin, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_tensor_special_argmax, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(tensor_special_method_entry) {
	...
	PHP_ABSTRACT_ME(Tensor_Special, argmin, arginfo_tensor_special_argmin)
