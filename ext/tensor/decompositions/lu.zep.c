...
PHP_METHOD(Tensor_Decompositions_Lu, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 10, l);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 11, u);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 12, p);
}
