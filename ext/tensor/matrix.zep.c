...
PHP_METHOD(Tensor_Matrix, build)
{
	...
	ZVAL_LONG(&_1, 0);
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 25, &a, &_0, &_1, &_2);
...
PHP_METHOD(Tensor_Matrix, fromTensorBuffer)
{
	...
	zval *a, a_sub, *m_param = NULL, *n_param = NULL, _0, _1, _2;
...
PHP_METHOD(Tensor_Matrix, identity)
{
	...
	if (UNEXPECTED(n < 1)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/matrix.zep", 92);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&a);
		...
		while (1) {
			...
			if (_8$$4 <= _9$$4) {
				while (1) {
					...
					zephir_array_append(&rowA, &_10$$5, PH_SEPARATE, "tensor/matrix.zep", 104);
				}
			}
			zephir_array_append(&a, &rowA, PH_SEPARATE, "tensor/matrix.zep", 107);
		}
	}
			...
			if (_5$$3 <= _6$$3) {
				while (1) {
					...
					if (i == j) {
						...
						zephir_array_fetch_long(&_7$$4, &elements, i, PH_NOISY, "tensor/matrix.zep", 161);
					} else {
						ZEPHIR_INIT_NVAR(&_7$$4);
						ZVAL_DOUBLE(&_7$$4, 0.0);
					}
					zephir_array_append(&rowA, &_7$$4, PH_SEPARATE, "tensor/matrix.zep", 161);
				}
			}
...
PHP_METHOD(Tensor_Matrix, rand)
{
	...
	if (UNEXPECTED(m < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 3, &_4$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/matrix.zep", 206);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(n < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 3, &_8$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "tensor/matrix.zep", 211);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&a);
	...
	while (1) {
		...
		while (1) {
			...
			zephir_array_append(&rowA, &_12$$6, PH_SEPARATE, "tensor/matrix.zep", 223);
		}
		zephir_array_append(&a, &rowA, PH_SEPARATE, "tensor/matrix.zep", 226);
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &a);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Tensor_Matrix, gaussian)
{
	...
	if (UNEXPECTED(m < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 3, &_4$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/matrix.zep", 244);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(n < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 3, &_8$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "tensor/matrix.zep", 249);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&a);
	...
	while (1) {
		...
		if (!(ZEPHIR_IS_EMPTY(&extras))) {
			...
			ZEPHIR_UNREF(&extras);
			zephir_check_call_status();
			zephir_array_append(&rowA, &_10$$6, PH_SEPARATE, "tensor/matrix.zep", 264);
		}
		while (1) {
			if (!(zephir_fast_count_int(&rowA) < n)) {
				break;
			...
			zephir_array_append(&rowA, &_19$$7, PH_SEPARATE, "tensor/matrix.zep", 272);
			ZVAL_DOUBLE(&_20$$7, phi);
			ZEPHIR_INIT_NVAR(&_19$$7);
			ZVAL_DOUBLE(&_19$$7, (r * cos(phi)));
			zephir_array_append(&rowA, &_19$$7, PH_SEPARATE, "tensor/matrix.zep", 273);
		}
		if (zephir_fast_count_int(&rowA) > n) {
			...
			ZEPHIR_UNREF(&rowA);
			zephir_check_call_status();
			zephir_array_append(&extras, &_21$$8, PH_SEPARATE, "tensor/matrix.zep", 277);
		}
		zephir_array_append(&a, &rowA, PH_SEPARATE, "tensor/matrix.zep", 280);
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &a);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Tensor_Matrix, poisson)
{
	...
	if (UNEXPECTED(m < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 3, &_4$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/matrix.zep", 299);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(n < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 3, &_8$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "tensor/matrix.zep", 304);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(lambda < 0.0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_9$$5, "tensor/matrix.zep", 309);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(lambda == 0.0)) {
	...
	while (1) {
		...
		while (1) {
			...
			zephir_array_append(&rowA, &_21$$8, PH_SEPARATE, "tensor/matrix.zep", 338);
		}
		zephir_array_append(&a, &rowA, PH_SEPARATE, "tensor/matrix.zep", 341);
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &a);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Tensor_Matrix, uniform)
{
	...
	if (UNEXPECTED(m < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 3, &_4$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/matrix.zep", 359);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(n < 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 3, &_8$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "tensor/matrix.zep", 364);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&a);
	...
	while (1) {
		...
		while (1) {
			...
			zephir_array_append(&rowA, &_14$$6, PH_SEPARATE, "tensor/matrix.zep", 376);
		}
		zephir_array_append(&a, &rowA, PH_SEPARATE, "tensor/matrix.zep", 379);
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &a);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Tensor_Matrix, __construct)
{
	...
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 1, 3, &a, &m_param, &n_param, &validate_param);
	...
	if (UNEXPECTED(Z_TYPE_P(a) == IS_ARRAY)) {
		rows$$3 = zephir_fast_count_int(a);
		ZEPHIR_INIT_VAR(&flat$$3);
		array_init(&flat$$3);
		ZEPHIR_CALL_FUNCTION(&_0$$3, "current", NULL, 27, a);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&firstRow) == IS_OBJECT) {
			if (UNEXPECTED(!((zephir_instance_of_ev(&firstRow, tensor_tensorbuffer_ce))))) {
				...
				object_init_ex(&_1$$7, tensor_exceptions_invalidargumentexception_ce);
				ZEPHIR_INIT_VAR(&_2$$7);
				ZEPHIR_CONCAT_SS(&_2$$7, "Matrix requires an", " array of arrays.");
				ZEPHIR_CALL_METHOD(NULL, &_1$$7, "__construct", NULL, 3, &_2$$7);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_1$$7, "tensor/matrix.zep", 408);
				ZEPHIR_MM_RESTORE();
				return;
			}
			ZEPHIR_CALL_METHOD(&nHat$$3, &firstRow, "count", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&nHat$$3, &nHat$$3);
		} else {
			ZEPHIR_INIT_NVAR(&nHat$$3);
			ZVAL_LONG(&nHat$$3, zephir_fast_count_int(&firstRow));
		}
		if (validate) {
			ZEPHIR_CALL_FUNCTION(&_3$$9, "array_values", NULL, 26, a);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(a, &_3$$9);
			if (Z_TYPE_P(a) == IS_STRING) {
				ZEPHIR_INIT_VAR(&_5$$9);
				zephir_string_to_char_array(&_5$$9, a);
				_4$$9 = &_5$$9;
			} else {
				_4$$9 = a;
			}
			zephir_is_iterable(_4$$9, 0, "tensor/matrix.zep", 447);
			if (Z_TYPE_P(_4$$9) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_4$$9), _7$$9, _8$$9, _6$$9)
				{
					ZEPHIR_INIT_NVAR(&i);
					if (_8$$9 != NULL) { 
						ZVAL_STR_COPY(&i, _8$$9);
					} else {
						ZVAL_LONG(&i, _7$$9);
					}
					ZEPHIR_INIT_NVAR(&rowA);
					...
					if (Z_TYPE_P(&rowA) == IS_OBJECT) {
						if (UNEXPECTED(!((zephir_instance_of_ev(&rowA, tensor_tensorbuffer_ce))))) {
							...
							object_init_ex(&_9$$12, tensor_exceptions_invalidargumentexception_ce);
							ZEPHIR_INIT_NVAR(&_10$$12);
							ZEPHIR_CONCAT_SS(&_10$$12, "Matrix requires an", " array of arrays.");
							ZEPHIR_CALL_METHOD(NULL, &_9$$12, "__construct", NULL, 3, &_10$$12);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_9$$12, "tensor/matrix.zep", 423);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_CALL_METHOD(&_11$$11, &rowA, "count", NULL, 0);
						zephir_check_call_status();
						if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_11$$11, &nHat$$3))) {
							ZEPHIR_INIT_NVAR(&_12$$13);
							object_init_ex(&_12$$13, tensor_exceptions_invalidargumentexception_ce);
							ZEPHIR_CALL_FUNCTION(&_13$$13, "strval", &_14, 4, &nHat$$3);
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_15$$13, &rowA, "count", NULL, 0);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_16$$13);
							ZEPHIR_CONCAT_SSVSVSVS(&_16$$13, "The number of", " columns must be equal for all rows, ", &_13$$13, " needed but ", &_15$$13, " given at row offset ", &i, ".");
							ZEPHIR_CALL_METHOD(NULL, &_12$$13, "__construct", NULL, 3, &_16$$13);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_12$$13, "tensor/matrix.zep", 430);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_CALL_METHOD(&_17$$11, &rowA, "toArray", NULL, 0);
						zephir_check_call_status();
						ZEPHIR_CPY_WRT(&rowA, &_17$$11);
					} else {
						if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&nHat$$3, zephir_fast_count_int(&rowA)))) {
							ZEPHIR_INIT_NVAR(&_18$$15);
							object_init_ex(&_18$$15, tensor_exceptions_invalidargumentexception_ce);
							ZEPHIR_CALL_FUNCTION(&_19$$15, "strval", &_14, 4, &nHat$$3);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_20$$15);
							ZVAL_LONG(&_20$$15, zephir_fast_count_int(&rowA));
							ZEPHIR_INIT_NVAR(&_21$$15);
							ZEPHIR_CONCAT_SSVSVSVS(&_21$$15, "The number of", " columns must be equal for all rows, ", &_19$$15, " needed but ", &_20$$15, " given at row offset ", &i, ".");
							ZEPHIR_CALL_METHOD(NULL, &_18$$15, "__construct", NULL, 3, &_21$$15);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_18$$15, "tensor/matrix.zep", 439);
							ZEPHIR_MM_RESTORE();
							return;
						}
					}
					if (Z_TYPE_P(&rowA) == IS_STRING) {
						...
						zephir_string_to_char_array(&_23$$10, &rowA);
						_22$$10 = &_23$$10;
					} else {
						_22$$10 = &rowA;
					}
					zephir_is_iterable(_22$$10, 0, "tensor/matrix.zep", 446);
					if (Z_TYPE_P(_22$$10) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_22$$10), _24$$10)
						{
							ZEPHIR_INIT_NVAR(&valueA);
							ZVAL_COPY(&valueA, _24$$10);
							ZEPHIR_INIT_NVAR(&_25$$16);
							ZEPHIR_CALL_FUNCTION(&_26$$16, "is_float", &_27, 2, &valueA);
							zephir_check_call_status();
							if (zephir_is_true(&_26$$16)) {
								ZEPHIR_CPY_WRT(&_25$$16, &valueA);
							} else {
								ZEPHIR_INIT_NVAR(&_25$$16);
								ZVAL_DOUBLE(&_25$$16, zephir_get_doubleval(&valueA));
							}
							zephir_array_append(&flat$$3, &_25$$16, PH_SEPARATE, "tensor/matrix.zep", 444);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, _22$$10, "rewind", NULL, 0);
						zephir_check_call_status();
						_29$$10 = 1;
						while (1) {
							if (_29$$10) {
								...
								ZEPHIR_CALL_METHOD(NULL, _22$$10, "next", NULL, 0);
								zephir_check_call_status();
							}
							ZEPHIR_CALL_METHOD(&_28$$10, _22$$10, "valid", NULL, 0);
							zephir_check_call_status();
							if (!zend_is_true(&_28$$10)) {
								break;
							}
							ZEPHIR_CALL_METHOD(&valueA, _22$$10, "current", NULL, 0);
							zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_30$$17);
								ZEPHIR_CALL_FUNCTION(&_31$$17, "is_float", &_27, 2, &valueA);
								zephir_check_call_status();
								if (zephir_is_true(&_31$$17)) {
									ZEPHIR_CPY_WRT(&_30$$17, &valueA);
								} else {
									ZEPHIR_INIT_NVAR(&_30$$17);
									ZVAL_DOUBLE(&_30$$17, zephir_get_doubleval(&valueA));
								}
								zephir_array_append(&flat$$3, &_30$$17, PH_SEPARATE, "tensor/matrix.zep", 444);
						}
					}
					ZEPHIR_INIT_NVAR(&valueA);
				} ZEND_HASH_FOREACH_END();
				...
				while (1) {
					...
					ZEPHIR_CALL_METHOD(&_32$$9, _4$$9, "valid", NULL, 0);
					zephir_check_call_status();
					if (!zend_is_true(&_32$$9)) {
						break;
					}
					ZEPHIR_CALL_METHOD(&i, _4$$9, "key", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&rowA, _4$$9, "current", NULL, 0);
					zephir_check_call_status();
						if (Z_TYPE_P(&rowA) == IS_OBJECT) {
							if (UNEXPECTED(!((zephir_instance_of_ev(&rowA, tensor_tensorbuffer_ce))))) {
								ZEPHIR_INIT_NVAR(&_34$$20);
								object_init_ex(&_34$$20, tensor_exceptions_invalidargumentexception_ce);
								ZEPHIR_INIT_NVAR(&_35$$20);
								ZEPHIR_CONCAT_SS(&_35$$20, "Matrix requires an", " array of arrays.");
								ZEPHIR_CALL_METHOD(NULL, &_34$$20, "__construct", NULL, 3, &_35$$20);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_34$$20, "tensor/matrix.zep", 423);
								ZEPHIR_MM_RESTORE();
								return;
							}
							ZEPHIR_CALL_METHOD(&_36$$19, &rowA, "count", NULL, 0);
							zephir_check_call_status();
							if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_36$$19, &nHat$$3))) {
								ZEPHIR_INIT_NVAR(&_37$$21);
								object_init_ex(&_37$$21, tensor_exceptions_invalidargumentexception_ce);
								ZEPHIR_CALL_FUNCTION(&_38$$21, "strval", &_14, 4, &nHat$$3);
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&_39$$21, &rowA, "count", NULL, 0);
								zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_40$$21);
								ZEPHIR_CONCAT_SSVSVSVS(&_40$$21, "The number of", " columns must be equal for all rows, ", &_38$$21, " needed but ", &_39$$21, " given at row offset ", &i, ".");
								ZEPHIR_CALL_METHOD(NULL, &_37$$21, "__construct", NULL, 3, &_40$$21);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_37$$21, "tensor/matrix.zep", 430);
								ZEPHIR_MM_RESTORE();
								return;
							}
							ZEPHIR_CALL_METHOD(&_41$$19, &rowA, "toArray", NULL, 0);
							zephir_check_call_status();
							ZEPHIR_CPY_WRT(&rowA, &_41$$19);
						} else {
							if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&nHat$$3, zephir_fast_count_int(&rowA)))) {
								ZEPHIR_INIT_NVAR(&_42$$23);
								object_init_ex(&_42$$23, tensor_exceptions_invalidargumentexception_ce);
								ZEPHIR_CALL_FUNCTION(&_43$$23, "strval", &_14, 4, &nHat$$3);
								zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_44$$23);
								ZVAL_LONG(&_44$$23, zephir_fast_count_int(&rowA));
								ZEPHIR_INIT_NVAR(&_45$$23);
								ZEPHIR_CONCAT_SSVSVSVS(&_45$$23, "The number of", " columns must be equal for all rows, ", &_43$$23, " needed but ", &_44$$23, " given at row offset ", &i, ".");
								ZEPHIR_CALL_METHOD(NULL, &_42$$23, "__construct", NULL, 3, &_45$$23);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_42$$23, "tensor/matrix.zep", 439);
								ZEPHIR_MM_RESTORE();
								return;
							}
						}
						if (Z_TYPE_P(&rowA) == IS_STRING) {
							...
							zephir_string_to_char_array(&_47$$18, &rowA);
							_46$$18 = &_47$$18;
						} else {
							_46$$18 = &rowA;
						}
						zephir_is_iterable(_46$$18, 0, "tensor/matrix.zep", 446);
						if (Z_TYPE_P(_46$$18) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_46$$18), _48$$18)
							{
								ZEPHIR_INIT_NVAR(&valueA);
								ZVAL_COPY(&valueA, _48$$18);
								ZEPHIR_INIT_NVAR(&_49$$24);
								ZEPHIR_CALL_FUNCTION(&_50$$24, "is_float", &_27, 2, &valueA);
								zephir_check_call_status();
								if (zephir_is_true(&_50$$24)) {
									ZEPHIR_CPY_WRT(&_49$$24, &valueA);
								} else {
									ZEPHIR_INIT_NVAR(&_49$$24);
									ZVAL_DOUBLE(&_49$$24, zephir_get_doubleval(&valueA));
								}
								zephir_array_append(&flat$$3, &_49$$24, PH_SEPARATE, "tensor/matrix.zep", 444);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, _46$$18, "rewind", NULL, 0);
							zephir_check_call_status();
							_52$$18 = 1;
							while (1) {
								if (_52$$18) {
									...
									ZEPHIR_CALL_METHOD(NULL, _46$$18, "next", NULL, 0);
									zephir_check_call_status();
								}
								ZEPHIR_CALL_METHOD(&_51$$18, _46$$18, "valid", NULL, 0);
								zephir_check_call_status();
								if (!zend_is_true(&_51$$18)) {
									break;
								}
								ZEPHIR_CALL_METHOD(&valueA, _46$$18, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_INIT_NVAR(&_53$$25);
									ZEPHIR_CALL_FUNCTION(&_54$$25, "is_float", &_27, 2, &valueA);
									zephir_check_call_status();
									if (zephir_is_true(&_54$$25)) {
										ZEPHIR_CPY_WRT(&_53$$25, &valueA);
									} else {
										ZEPHIR_INIT_NVAR(&_53$$25);
										ZVAL_DOUBLE(&_53$$25, zephir_get_doubleval(&valueA));
									}
									zephir_array_append(&flat$$3, &_53$$25, PH_SEPARATE, "tensor/matrix.zep", 444);
							}
						}
						ZEPHIR_INIT_NVAR(&valueA);
				}
			...
			if (Z_TYPE_P(a) == IS_STRING) {
				...
				zephir_string_to_char_array(&_56$$26, a);
				_55$$26 = &_56$$26;
			} else {
				_55$$26 = a;
			}
			zephir_is_iterable(_55$$26, 0, "tensor/matrix.zep", 476);
			if (Z_TYPE_P(_55$$26) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_55$$26), _58$$26, _59$$26, _57$$26)
				{
					ZEPHIR_INIT_NVAR(&i);
					if (_59$$26 != NULL) { 
						ZVAL_STR_COPY(&i, _59$$26);
					} else {
						ZVAL_LONG(&i, _58$$26);
					}
					ZEPHIR_INIT_NVAR(&rowA);
					ZVAL_COPY(&rowA, _57$$26);
					if (Z_TYPE_P(&rowA) == IS_OBJECT) {
						if (UNEXPECTED(!((zephir_instance_of_ev(&rowA, tensor_tensorbuffer_ce))))) {
							ZEPHIR_INIT_NVAR(&_60$$29);
							object_init_ex(&_60$$29, tensor_exceptions_invalidargumentexception_ce);
							ZEPHIR_INIT_NVAR(&_61$$29);
							ZEPHIR_CONCAT_SS(&_61$$29, "Matrix requires an", " array of arrays.");
							ZEPHIR_CALL_METHOD(NULL, &_60$$29, "__construct", NULL, 3, &_61$$29);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_60$$29, "tensor/matrix.zep", 452);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_CALL_METHOD(&_62$$28, &rowA, "count", NULL, 0);
						zephir_check_call_status();
						if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_62$$28, &nHat$$3))) {
							ZEPHIR_INIT_NVAR(&_63$$30);
							object_init_ex(&_63$$30, tensor_exceptions_invalidargumentexception_ce);
							ZEPHIR_CALL_FUNCTION(&_64$$30, "strval", &_14, 4, &nHat$$3);
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_65$$30, &rowA, "count", NULL, 0);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_66$$30);
							ZEPHIR_CONCAT_SSVSVSVS(&_66$$30, "The number of", " columns must be equal for all rows, ", &_64$$30, " needed but ", &_65$$30, " given at row offset ", &i, ".");
							ZEPHIR_CALL_METHOD(NULL, &_63$$30, "__construct", NULL, 3, &_66$$30);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_63$$30, "tensor/matrix.zep", 459);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_CALL_METHOD(&_67$$28, &rowA, "toArray", NULL, 0);
						zephir_check_call_status();
						ZEPHIR_CPY_WRT(&rowA, &_67$$28);
					} else {
						if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&nHat$$3, zephir_fast_count_int(&rowA)))) {
							ZEPHIR_INIT_NVAR(&_68$$32);
							object_init_ex(&_68$$32, tensor_exceptions_invalidargumentexception_ce);
							ZEPHIR_CALL_FUNCTION(&_69$$32, "strval", &_14, 4, &nHat$$3);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_70$$32);
							ZVAL_LONG(&_70$$32, zephir_fast_count_int(&rowA));
							ZEPHIR_INIT_NVAR(&_71$$32);
							ZEPHIR_CONCAT_SSVSVSVS(&_71$$32, "The number of", " columns must be equal for all rows, ", &_69$$32, " needed but ", &_70$$32, " given at row offset ", &i, ".");
							ZEPHIR_CALL_METHOD(NULL, &_68$$32, "__construct", NULL, 3, &_71$$32);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_68$$32, "tensor/matrix.zep", 468);
							ZEPHIR_MM_RESTORE();
							return;
						}
					}
					if (Z_TYPE_P(&rowA) == IS_STRING) {
						ZEPHIR_INIT_NVAR(&_73$$27);
						zephir_string_to_char_array(&_73$$27, &rowA);
						_72$$27 = &_73$$27;
					} else {
						_72$$27 = &rowA;
					}
					zephir_is_iterable(_72$$27, 0, "tensor/matrix.zep", 475);
					if (Z_TYPE_P(_72$$27) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_72$$27), _74$$27)
						{
							ZEPHIR_INIT_NVAR(&valueA);
							ZVAL_COPY(&valueA, _74$$27);
							ZEPHIR_INIT_NVAR(&_75$$33);
							ZVAL_DOUBLE(&_75$$33, zephir_get_doubleval(&valueA));
							zephir_array_append(&flat$$3, &_75$$33, PH_SEPARATE, "tensor/matrix.zep", 473);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, _72$$27, "rewind", NULL, 0);
						zephir_check_call_status();
						_77$$27 = 1;
						while (1) {
							if (_77$$27) {
								...
								ZEPHIR_CALL_METHOD(NULL, _72$$27, "next", NULL, 0);
								zephir_check_call_status();
							}
							ZEPHIR_CALL_METHOD(&_76$$27, _72$$27, "valid", NULL, 0);
							zephir_check_call_status();
							if (!zend_is_true(&_76$$27)) {
								break;
							}
							ZEPHIR_CALL_METHOD(&valueA, _72$$27, "current", NULL, 0);
							zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_78$$34);
								ZVAL_DOUBLE(&_78$$34, zephir_get_doubleval(&valueA));
								zephir_array_append(&flat$$3, &_78$$34, PH_SEPARATE, "tensor/matrix.zep", 473);
						}
					}
					ZEPHIR_INIT_NVAR(&valueA);
				} ZEND_HASH_FOREACH_END();
			} else {
				ZEPHIR_CALL_METHOD(NULL, _55$$26, "rewind", NULL, 0);
				zephir_check_call_status();
				_80$$26 = 1;
				while (1) {
					if (_80$$26) {
						...
						ZEPHIR_CALL_METHOD(NULL, _55$$26, "next", NULL, 0);
						zephir_check_call_status();
					}
					ZEPHIR_CALL_METHOD(&_79$$26, _55$$26, "valid", NULL, 0);
					zephir_check_call_status();
					if (!zend_is_true(&_79$$26)) {
						break;
					}
					ZEPHIR_CALL_METHOD(&i, _55$$26, "key", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&rowA, _55$$26, "current", NULL, 0);
					zephir_check_call_status();
						if (Z_TYPE_P(&rowA) == IS_OBJECT) {
							if (UNEXPECTED(!((zephir_instance_of_ev(&rowA, tensor_tensorbuffer_ce))))) {
								ZEPHIR_INIT_NVAR(&_81$$37);
								object_init_ex(&_81$$37, tensor_exceptions_invalidargumentexception_ce);
								ZEPHIR_INIT_NVAR(&_82$$37);
								ZEPHIR_CONCAT_SS(&_82$$37, "Matrix requires an", " array of arrays.");
								ZEPHIR_CALL_METHOD(NULL, &_81$$37, "__construct", NULL, 3, &_82$$37);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_81$$37, "tensor/matrix.zep", 452);
								ZEPHIR_MM_RESTORE();
								return;
							}
							ZEPHIR_CALL_METHOD(&_83$$36, &rowA, "count", NULL, 0);
							zephir_check_call_status();
							if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_83$$36, &nHat$$3))) {
								ZEPHIR_INIT_NVAR(&_84$$38);
								object_init_ex(&_84$$38, tensor_exceptions_invalidargumentexception_ce);
								ZEPHIR_CALL_FUNCTION(&_85$$38, "strval", &_14, 4, &nHat$$3);
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&_86$$38, &rowA, "count", NULL, 0);
								zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_87$$38);
								ZEPHIR_CONCAT_SSVSVSVS(&_87$$38, "The number of", " columns must be equal for all rows, ", &_85$$38, " needed but ", &_86$$38, " given at row offset ", &i, ".");
								ZEPHIR_CALL_METHOD(NULL, &_84$$38, "__construct", NULL, 3, &_87$$38);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_84$$38, "tensor/matrix.zep", 459);
								ZEPHIR_MM_RESTORE();
								return;
							}
							ZEPHIR_CALL_METHOD(&_88$$36, &rowA, "toArray", NULL, 0);
							zephir_check_call_status();
							ZEPHIR_CPY_WRT(&rowA, &_88$$36);
						} else {
							if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&nHat$$3, zephir_fast_count_int(&rowA)))) {
								ZEPHIR_INIT_NVAR(&_89$$40);
								object_init_ex(&_89$$40, tensor_exceptions_invalidargumentexception_ce);
								ZEPHIR_CALL_FUNCTION(&_90$$40, "strval", &_14, 4, &nHat$$3);
								zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_91$$40);
								ZVAL_LONG(&_91$$40, zephir_fast_count_int(&rowA));
								ZEPHIR_INIT_NVAR(&_92$$40);
								ZEPHIR_CONCAT_SSVSVSVS(&_92$$40, "The number of", " columns must be equal for all rows, ", &_90$$40, " needed but ", &_91$$40, " given at row offset ", &i, ".");
								ZEPHIR_CALL_METHOD(NULL, &_89$$40, "__construct", NULL, 3, &_92$$40);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_89$$40, "tensor/matrix.zep", 468);
								ZEPHIR_MM_RESTORE();
								return;
							}
						}
						if (Z_TYPE_P(&rowA) == IS_STRING) {
							ZEPHIR_INIT_NVAR(&_94$$35);
							zephir_string_to_char_array(&_94$$35, &rowA);
							_93$$35 = &_94$$35;
						} else {
							_93$$35 = &rowA;
						}
						zephir_is_iterable(_93$$35, 0, "tensor/matrix.zep", 475);
						if (Z_TYPE_P(_93$$35) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_93$$35), _95$$35)
							{
								ZEPHIR_INIT_NVAR(&valueA);
								ZVAL_COPY(&valueA, _95$$35);
								ZEPHIR_INIT_NVAR(&_96$$41);
								ZVAL_DOUBLE(&_96$$41, zephir_get_doubleval(&valueA));
								zephir_array_append(&flat$$3, &_96$$41, PH_SEPARATE, "tensor/matrix.zep", 473);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, _93$$35, "rewind", NULL, 0);
							zephir_check_call_status();
							_98$$35 = 1;
							while (1) {
								if (_98$$35) {
									...
									ZEPHIR_CALL_METHOD(NULL, _93$$35, "next", NULL, 0);
									zephir_check_call_status();
								}
								ZEPHIR_CALL_METHOD(&_97$$35, _93$$35, "valid", NULL, 0);
								zephir_check_call_status();
								if (!zend_is_true(&_97$$35)) {
									break;
								}
								ZEPHIR_CALL_METHOD(&valueA, _93$$35, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_INIT_NVAR(&_99$$42);
									ZVAL_DOUBLE(&_99$$42, zephir_get_doubleval(&valueA));
									zephir_array_append(&flat$$3, &_99$$42, PH_SEPARATE, "tensor/matrix.zep", 473);
							}
						}
						ZEPHIR_INIT_NVAR(&valueA);
				}
		...
		ZEPHIR_INIT_VAR(&buffer$$3);
		tensor_buffer_from_array(&buffer$$3, &flat$$3);
		ZEPHIR_INIT_VAR(&_100$$3);
		object_init_ex(&_100$$3, tensor_tensorbuffer_ce);
		ZEPHIR_CALL_METHOD(NULL, &_100$$3, "__construct", NULL, 14, &buffer$$3);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 14, &_100$$3);
		ZVAL_UNDEF(&_101$$3);
		ZVAL_LONG(&_101$$3, rows$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 15, &_101$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 16, &nHat$$3);
	} else if (zephir_instance_of_ev(a, tensor_tensorbuffer_ce)) {
		if (UNEXPECTED(validate)) {
			if (UNEXPECTED(m < 1)) {
				ZEPHIR_INIT_VAR(&_102$$45);
				object_init_ex(&_102$$45, tensor_exceptions_invalidargumentexception_ce);
				ZVAL_LONG(&_103$$45, m);
				ZEPHIR_CALL_FUNCTION(&_104$$45, "strval", &_14, 4, &_103$$45);
				zephir_check_call_status();
				ZEPHIR_INIT_VAR(&_105$$45);
				ZEPHIR_CONCAT_SSVS(&_105$$45, "The number of rows must be", " greater than 0, ", &_104$$45, " given.");
				ZEPHIR_CALL_METHOD(NULL, &_102$$45, "__construct", NULL, 3, &_105$$45);
				zephir_check_call_status();
			...
			if (UNEXPECTED(n < 1)) {
				ZEPHIR_INIT_VAR(&_106$$46);
				object_init_ex(&_106$$46, tensor_exceptions_invalidargumentexception_ce);
				ZVAL_LONG(&_107$$46, n);
				ZEPHIR_CALL_FUNCTION(&_108$$46, "strval", &_14, 4, &_107$$46);
				zephir_check_call_status();
				ZEPHIR_INIT_VAR(&_109$$46);
				ZEPHIR_CONCAT_SSVS(&_109$$46, "The number of columns must be", " greater than 0, ", &_108$$46, " given.");
				ZEPHIR_CALL_METHOD(NULL, &_106$$46, "__construct", NULL, 3, &_109$$46);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_106$$46, "tensor/matrix.zep", 492);
				ZEPHIR_MM_RESTORE();
				return;
			}
			ZEPHIR_CALL_METHOD(&_110$$44, a, "count", NULL, 0);
			zephir_check_call_status();
			if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&_110$$44, (m * n)))) {
				ZEPHIR_INIT_VAR(&_111$$47);
				object_init_ex(&_111$$47, tensor_exceptions_invalidargumentexception_ce);
				ZEPHIR_CALL_METHOD(&_112$$47, a, "count", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_113$$47, "strval", &_14, 4, &_112$$47);
				zephir_check_call_status();
				ZEPHIR_INIT_VAR(&_114$$47);
				ZEPHIR_CONCAT_SSVS(&_114$$47, "The number of elements", " in the buffer must equal m times n, ", &_113$$47, " given.");
				ZEPHIR_CALL_METHOD(NULL, &_111$$47, "__construct", NULL, 3, &_114$$47);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_111$$47, "tensor/matrix.zep", 498);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
		...
		ZVAL_UNDEF(&_115$$43);
		ZVAL_LONG(&_115$$43, m);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 15, &_115$$43);
		ZVAL_UNDEF(&_115$$43);
		ZVAL_LONG(&_115$$43, n);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 16, &_115$$43);
	} else {
		ZEPHIR_INIT_VAR(&_116$$48);
		object_init_ex(&_116$$48, tensor_exceptions_invalidargumentexception_ce);
		ZEPHIR_INIT_VAR(&_117$$48);
		ZEPHIR_CONCAT_SS(&_117$$48, "Matrix requires an array", " or TensorBuffer object.");
		ZEPHIR_CALL_METHOD(NULL, &_116$$48, "__construct", NULL, 3, &_117$$48);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_116$$48, "tensor/matrix.zep", 507);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Tensor_Matrix, rowAsVector)
{
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/matrix.zep", 582);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Tensor_Matrix, columnAsVector)
{
	...
	if (UNEXPECTED(_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 3, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/matrix.zep", 599);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 14, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Tensor_Matrix, asArray)
{
	...
	zephir_is_iterable(_4, 0, "tensor/matrix.zep", 650);
	if (Z_TYPE_P(_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_4), _6)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_7$$4, PH_SEPARATE, "tensor/matrix.zep", 647);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_10$$5, PH_SEPARATE, "tensor/matrix.zep", 647);
		}
	}
	ZEPHIR_INIT_NVAR(&rowBuffer);
	RETURN_CTOR(&b);
...
PHP_METHOD(Tensor_Matrix, asRowVectors)
{
	...
	zephir_is_iterable(_4, 0, "tensor/matrix.zep", 686);
	if (Z_TYPE_P(_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_4), _6)
		{
			ZEPHIR_INIT_NVAR(&rowBuffer);
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_7$$4, PH_SEPARATE, "tensor/matrix.zep", 683);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _4, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_11$$5, PH_SEPARATE, "tensor/matrix.zep", 683);
		}
	}
	ZEPHIR_INIT_NVAR(&rowBuffer);
	RETURN_CTOR(&b);
...
PHP_METHOD(Tensor_Matrix, asColumnBuffers)
{
	...
	if (_3 <= _4) {
		while (1) {
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_6$$4, PH_SEPARATE, "tensor/matrix.zep", 705);
		}
	}
	RETURN_CTOR(&b);
}
...
PHP_METHOD(Tensor_Matrix, asColumnVectors)
{
	...
	zephir_is_iterable(_2, 0, "tensor/matrix.zep", 730);
	if (Z_TYPE_P(_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_2), _4)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_5$$4, PH_SEPARATE, "tensor/matrix.zep", 727);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_9$$5, PH_SEPARATE, "tensor/matrix.zep", 727);
		}
	}
	ZEPHIR_INIT_NVAR(&columnBuffer);
	RETURN_CTOR(&b);
...
PHP_METHOD(Tensor_Matrix, transpose)
{
	...
	zephir_array_fetch_long(&col, &cols, 0, PH_NOISY, "tensor/matrix.zep", 795);
	ZVAL_LONG(&_1, 1);
	ZEPHIR_CALL_FUNCTION(&_2, "array_slice", NULL, 28, &cols, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &col, "concat", NULL, 0, &_2);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&col, &_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 16, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 15, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &col, &_1, &_3);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, inverse)
{
	...
	if (UNEXPECTED(!zephir_is_true(&_4))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "tensor/matrix.zep", 817);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (Z_TYPE_P(&result) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_9$$5, "__construct", NULL, 29, &_10$$5);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_9$$5, "tensor/matrix.zep", 824);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &result, &_11, &_12);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, pseudoinverse)
{
	...
	if (Z_TYPE_P(&result) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "tensor/matrix.zep", 841);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 16, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 15, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &result, &_5, &_6);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, det)
{
	...
	if (UNEXPECTED(!zephir_is_true(&_0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 3, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "tensor/matrix.zep", 857);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Tensor_Matrix, rank)
{
	...
	pivots = 0;
	epsilon =  (0.00000001);
	zephir_is_iterable(&a, 0, "tensor/matrix.zep", 912);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&a), _4)
	{
		...
		zephir_is_iterable(_5$$3, 0, "tensor/matrix.zep", 910);
...
{
	zend_bool _2, _6$$4;
	zval _0, _1, _5$$4, _9$$5, _10$$5, _11$$5, _12$$5, _13$$5, _14$$5, _15$$5;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	if (_3 <= _4) {
		while (1) {
			...
			i = _3;
			zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
			...
			if (_7$$4 <= _8$$4) {
				while (1) {
					...
					j = _7$$4;
					zephir_read_property_cached(&_9$$5, this_ptr, _zephir_prop_2, 14, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
					ZVAL_LONG(&_12$$5, ((i * (zend_long) zephir_get_numberval(&_11$$5)) + j));
					ZEPHIR_CALL_METHOD(&_10$$5, &_9$$5, "get", NULL, 0, &_12$$5);
					zephir_check_call_status();
					zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_2, 14, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_14$$5, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
					ZVAL_LONG(&_15$$5, ((j * (zend_long) zephir_get_numberval(&_14$$5)) + i));
					ZEPHIR_CALL_METHOD(&_13$$5, &_12$$5, "get", NULL, 0, &_15$$5);
					zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, matmul)
{
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &result, &_13, &_14);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, convolve)
{
	...
	if (UNEXPECTED(_2)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$3, "tensor/matrix.zep", 999);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(stride < 1)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_7$$4, "tensor/matrix.zep", 1004);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&result);
	...
	ZVAL_LONG(&_20, outM);
	ZVAL_LONG(&_22, outN);
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &result, &_20, &_22);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, multiply)
{
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/matrix.zep", 1148);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Matrix, equal)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/matrix.zep", 1351);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Matrix, notEqual)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/matrix.zep", 1385);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Matrix, greater)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/matrix.zep", 1419);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Matrix, greaterEqual)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/matrix.zep", 1453);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Matrix, less)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/matrix.zep", 1487);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Matrix, lessEqual)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 3, &_3);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "tensor/matrix.zep", 1521);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Tensor_Matrix, log)
{
	...
	zval b;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_9 = NULL, *_11 = NULL, *_12 = NULL, *_17 = NULL, *_19 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, i = 0;
	zval *base_param = NULL, _0$$3, rowA, valueA, _1, _2, _3, *_4, _5, *_6, _13, _7$$4, _8$$5, _10$$5, _15$$6, _16$$7, _18$$7;
	double base;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_4, 0, "tensor/matrix.zep", 1617);
	if (Z_TYPE_P(_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_4), _6)
		{
			ZEPHIR_INIT_NVAR(&rowA);
			...
			i = 0;
			while (1) {
				zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
				if (!(ZEPHIR_GT_LONG(&_7$$4, i))) {
					break;
				}
				ZVAL_LONG(&_8$$5, i);
				ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_9, 0, &_8$$5);
				zephir_check_call_status();
				ZVAL_DOUBLE(&_8$$5, base);
				ZEPHIR_CALL_FUNCTION(&_10$$5, "log", &_11, 8, &valueA, &_8$$5);
				zephir_check_call_status();
				ZVAL_LONG(&_8$$5, i);
				ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_12, 0, &_8$$5, &_10$$5);
				zephir_check_call_status();
				i++;
			}
			zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 1614);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _4, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_13, _4, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_13)) {
				break;
			}
			...
			zephir_check_call_status();
				...
				while (1) {
					...
					if (!(ZEPHIR_GT_LONG(&_15$$6, i))) {
						break;
					}
					ZVAL_LONG(&_16$$7, i);
					ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_17, 0, &_16$$7);
					zephir_check_call_status();
					ZVAL_DOUBLE(&_16$$7, base);
					ZEPHIR_CALL_FUNCTION(&_18$$7, "log", &_11, 8, &valueA, &_16$$7);
					zephir_check_call_status();
					ZVAL_LONG(&_16$$7, i);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_19, 0, &_16$$7, &_18$$7);
					zephir_check_call_status();
					i++;
				}
				zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 1614);
...
PHP_METHOD(Tensor_Matrix, sum)
{
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 1725);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_6$$3, PH_SEPARATE, "tensor/matrix.zep", 1722);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_9$$4, PH_SEPARATE, "tensor/matrix.zep", 1722);
		}
	}
	ZEPHIR_INIT_NVAR(&rowBuffer);
...
PHP_METHOD(Tensor_Matrix, product)
{
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 1743);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&rowBuffer);
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_6$$3, PH_SEPARATE, "tensor/matrix.zep", 1740);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_9$$4, PH_SEPARATE, "tensor/matrix.zep", 1740);
		}
	}
	ZEPHIR_INIT_NVAR(&rowBuffer);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_columnvector_ce, "quick", NULL, 0, &b);
...
PHP_METHOD(Tensor_Matrix, min)
{
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 1761);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&rowBuffer);
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_6$$3, PH_SEPARATE, "tensor/matrix.zep", 1758);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_9$$4, PH_SEPARATE, "tensor/matrix.zep", 1758);
		}
	}
	ZEPHIR_INIT_NVAR(&rowBuffer);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_columnvector_ce, "quick", NULL, 0, &b);
...
PHP_METHOD(Tensor_Matrix, max)
{
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 1779);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&rowBuffer);
			...
			zephir_check_call_status();
			zephir_array_append(&b, &_6$$3, PH_SEPARATE, "tensor/matrix.zep", 1776);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&b, &_9$$4, PH_SEPARATE, "tensor/matrix.zep", 1776);
		}
	}
	ZEPHIR_INIT_NVAR(&rowBuffer);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_columnvector_ce, "quick", NULL, 0, &b);
...
PHP_METHOD(Tensor_Matrix, median)
{
	...
	zephir_is_iterable(_6, 0, "tensor/matrix.zep", 1818);
	if (Z_TYPE_P(_6) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_6), _8)
		{
			...
			zephir_array_append(&b, &median, PH_SEPARATE, "tensor/matrix.zep", 1815);
		} ZEND_HASH_FOREACH_END();
	} else {
...
PHP_METHOD(Tensor_Matrix, quantile)
{
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "tensor/matrix.zep", 1832);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&b);
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 1860);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _11)
		{
			...
			if (ZEPHIR_LE_LONG(&_12$$4, xHat)) {
				...
				zephir_array_append(&b, &_16$$5, PH_SEPARATE, "tensor/matrix.zep", 1850);
				continue;
			}
			...
			zephir_array_append(&b, &_20$$4, PH_SEPARATE, "tensor/matrix.zep", 1857);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_LE_LONG(&_23$$6, xHat)) {
					...
					zephir_array_append(&b, &_27$$7, PH_SEPARATE, "tensor/matrix.zep", 1850);
					continue;
				}
				...
				zephir_array_append(&b, &_31$$6, PH_SEPARATE, "tensor/matrix.zep", 1857);
		}
	}
	ZEPHIR_INIT_NVAR(&rowBuffer);
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_columnvector_ce, "quick", NULL, 0, &b);
...
PHP_METHOD(Tensor_Matrix, variance)
{
	...
	if (!(Z_TYPE_P(mean) == IS_NULL)) {
		...
		if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_3$$3, &_4$$3))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_5$$5, "tensor/matrix.zep", 1882);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} else {
...
PHP_METHOD(Tensor_Matrix, covariance)
{
	...
	if (!(Z_TYPE_P(mean) == IS_NULL)) {
		...
		if (!ZEPHIR_IS_IDENTICAL(&_0$$3, &_1$$3)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_2$$4, "tensor/matrix.zep", 1907);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} else {
...
PHP_METHOD(Tensor_Matrix, round)
{
	...
	zval b;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_13 = NULL, *_16 = NULL, *_21 = NULL, *_24 = NULL;
	zval *precision_param = NULL, _0$$3, _1$$4, _2$$4, _3$$4, _4$$4, rowA, valueA, _5, _6, _7, *_8, _9, *_10, _17, _11$$5, _12$$6, _14$$6, _15$$6, _19$$7, _20$$8, _22$$8, _23$$8;
	...
	if (UNEXPECTED(precision < 0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "tensor/matrix.zep", 1933);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&b);
	...
	ZEPHIR_CALL_METHOD(&_6, &_5, "split", NULL, 0, &_7);
	zephir_check_call_status();
	if (Z_TYPE_P(&_6) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_9);
		zephir_string_to_char_array(&_9, &_6);
		_8 = &_9;
	} else {
		_8 = &_6;
	}
	zephir_is_iterable(_8, 0, "tensor/matrix.zep", 1956);
	if (Z_TYPE_P(_8) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_8), _10)
		{
			...
			while (1) {
				zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
				if (!(ZEPHIR_GT_LONG(&_11$$5, i))) {
					break;
				}
				ZVAL_LONG(&_12$$6, i);
				ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_13, 0, &_12$$6);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_14$$6);
				ZVAL_LONG(&_12$$6, precision);
				zephir_round(&_14$$6, &valueA, &_12$$6, NULL);
				ZVAL_LONG(&_15$$6, i);
				ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_16, 0, &_15$$6, &_14$$6);
				zephir_check_call_status();
				i++;
			}
			zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 1953);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				i = 0;
				while (1) {
					zephir_read_property_cached(&_19$$7, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
					if (!(ZEPHIR_GT_LONG(&_19$$7, i))) {
						break;
					}
					ZVAL_LONG(&_20$$8, i);
					ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_21, 0, &_20$$8);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_22$$8);
					ZVAL_LONG(&_20$$8, precision);
					zephir_round(&_22$$8, &valueA, &_20$$8, NULL);
					ZVAL_LONG(&_23$$8, i);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_24, 0, &_23$$8, &_22$$8);
					zephir_check_call_status();
					i++;
				}
				zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 1953);
...
PHP_METHOD(Tensor_Matrix, clip)
{
	...
	zval _1$$3;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_10 = NULL, *_13 = NULL, *_16 = NULL, *_21 = NULL, *_24 = NULL, *_27 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, i = 0;
	zval *min_param = NULL, *max_param = NULL, _0$$3, rowA, valueA, _2, _3, _4, *_5, _6, *_7, _17, _8$$4, _9$$5, _11$$6, _12$$6, _14$$7, _15$$7, _19$$8, _20$$9, _22$$10, _23$$10, _25$$11, _26$$11;
	double min, max;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(min > max)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/matrix.zep", 1992);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&b);
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_3, &_2, "split", NULL, 0, &_4);
	zephir_check_call_status();
	...
	zephir_is_iterable(_5, 0, "tensor/matrix.zep", 2029);
	if (Z_TYPE_P(_5) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_5), _7)
		{
			...
			i = 0;
			while (1) {
				zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
				if (!(ZEPHIR_GT_LONG(&_8$$4, i))) {
					break;
				}
				ZVAL_LONG(&_9$$5, i);
				ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_10, 0, &_9$$5);
				zephir_check_call_status();
				if (ZEPHIR_GT_DOUBLE(&valueA, max)) {
					ZVAL_LONG(&_11$$6, i);
					ZVAL_DOUBLE(&_12$$6, max);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_13, 0, &_11$$6, &_12$$6);
					zephir_check_call_status();
					i++;
					continue;
				}
				if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
					ZVAL_LONG(&_14$$7, i);
					ZVAL_DOUBLE(&_15$$7, min);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_16, 0, &_14$$7, &_15$$7);
					zephir_check_call_status();
					i++;
					continue;
				}
			...
			zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 2026);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				i = 0;
				while (1) {
					zephir_read_property_cached(&_19$$8, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
					if (!(ZEPHIR_GT_LONG(&_19$$8, i))) {
						break;
					}
					ZVAL_LONG(&_20$$9, i);
					ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_21, 0, &_20$$9);
					zephir_check_call_status();
					if (ZEPHIR_GT_DOUBLE(&valueA, max)) {
						ZVAL_LONG(&_22$$10, i);
						ZVAL_DOUBLE(&_23$$10, max);
						ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_24, 0, &_22$$10, &_23$$10);
						zephir_check_call_status();
						i++;
						continue;
					}
					if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
						ZVAL_LONG(&_25$$11, i);
						ZVAL_DOUBLE(&_26$$11, min);
						ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_27, 0, &_25$$11, &_26$$11);
						zephir_check_call_status();
						i++;
						continue;
					}
...
PHP_METHOD(Tensor_Matrix, clipLower)
{
	...
	zval b;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_8 = NULL, *_11 = NULL, *_16 = NULL, *_19 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, i = 0;
	zval *min_param = NULL, rowA, valueA, _0, _1, _2, *_3, _4, *_5, _12, _6$$3, _7$$4, _9$$5, _10$$5, _14$$6, _15$$7, _17$$8, _18$$8;
	double min;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 2062);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&rowA);
			...
			i = 0;
			while (1) {
				zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
				if (!(ZEPHIR_GT_LONG(&_6$$3, i))) {
					break;
				}
				ZVAL_LONG(&_7$$4, i);
				ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_8, 0, &_7$$4);
				zephir_check_call_status();
				if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
					ZVAL_LONG(&_9$$5, i);
					ZVAL_DOUBLE(&_10$$5, min);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_11, 0, &_9$$5, &_10$$5);
					zephir_check_call_status();
				}
				i++;
			}
			zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 2059);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				i = 0;
				while (1) {
					zephir_read_property_cached(&_14$$6, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
					if (!(ZEPHIR_GT_LONG(&_14$$6, i))) {
						break;
					}
					ZVAL_LONG(&_15$$7, i);
					ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_16, 0, &_15$$7);
					zephir_check_call_status();
					if (ZEPHIR_LT_DOUBLE(&valueA, min)) {
						ZVAL_LONG(&_17$$8, i);
						ZVAL_DOUBLE(&_18$$8, min);
						ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_19, 0, &_17$$8, &_18$$8);
						zephir_check_call_status();
					}
					i++;
				}
...
PHP_METHOD(Tensor_Matrix, clipUpper)
{
	...
	zephir_fcall_cache_entry *_8 = NULL, *_11 = NULL, *_16 = NULL, *_19 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, i = 0;
	zval *max_param = NULL, rowA, valueA, _0, _1, _2, *_3, _4, *_5, _12, _6$$3, _7$$4, _9$$5, _10$$5, _14$$6, _15$$7, _17$$8, _18$$8;
	double max;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 2095);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&rowA);
			...
			while (1) {
				...
				if (ZEPHIR_GT_DOUBLE(&valueA, max)) {
					ZVAL_LONG(&_9$$5, i);
					ZVAL_DOUBLE(&_10$$5, max);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_11, 0, &_9$$5, &_10$$5);
					zephir_check_call_status();
				}
				i++;
			}
			zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 2092);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, sign)
{
	zend_bool _19;
	zval b;
	zval rowA, valueA, _0, _1, _2, *_3, _4, *_5, _18, _6$$3, _7$$4, _9$$5, _10$$5, _12$$6, _13$$6, _15$$7, _16$$7, _20$$8, _21$$9, _23$$10, _24$$10, _26$$11, _27$$11, _29$$12, _30$$12;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_8 = NULL, *_11 = NULL, *_14 = NULL, *_17 = NULL, *_22 = NULL, *_25 = NULL, *_28 = NULL, *_31 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, i = 0;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 2131);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&rowA);
			...
			while (1) {
				...
				if (ZEPHIR_GT_LONG(&valueA, 0)) {
					...
					ZVAL_LONG(&_12$$6, i);
					ZVAL_DOUBLE(&_13$$6, -1.0);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_14, 0, &_12$$6, &_13$$6);
					zephir_check_call_status();
				} else {
					ZVAL_LONG(&_15$$7, i);
					ZVAL_DOUBLE(&_16$$7, 0.0);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_17, 0, &_15$$7, &_16$$7);
					zephir_check_call_status();
				}
				i++;
			}
			zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 2128);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_18, _3, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_18)) {
				break;
			}
			...
			zephir_check_call_status();
				i = 0;
				while (1) {
					zephir_read_property_cached(&_20$$8, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
					if (!(ZEPHIR_GT_LONG(&_20$$8, i))) {
						break;
					}
					ZVAL_LONG(&_21$$9, i);
					ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_22, 0, &_21$$9);
					zephir_check_call_status();
					if (ZEPHIR_GT_LONG(&valueA, 0)) {
						ZVAL_LONG(&_23$$10, i);
						ZVAL_DOUBLE(&_24$$10, 1.0);
						ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_25, 0, &_23$$10, &_24$$10);
						zephir_check_call_status();
					} else if (ZEPHIR_LT_LONG(&valueA, 0)) {
						ZVAL_LONG(&_26$$11, i);
						ZVAL_DOUBLE(&_27$$11, -1.0);
						ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_28, 0, &_26$$11, &_27$$11);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(&_29$$12, i);
						ZVAL_DOUBLE(&_30$$12, 0.0);
						ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_31, 0, &_29$$12, &_30$$12);
						zephir_check_call_status();
					}
					i++;
				}
...
PHP_METHOD(Tensor_Matrix, negate)
{
	zend_bool _11;
	zval b;
	zval rowA, valueA, _0, _1, _2, *_3, _4, *_5, _10, _6$$3, _7$$4, _12$$5, _13$$6;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_8 = NULL, *_9 = NULL, *_14 = NULL, *_15 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, i = 0;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_3, 0, "tensor/matrix.zep", 2161);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&rowA);
			...
			while (1) {
				...
				ZVAL_LONG(&_7$$4, i);
				ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_9, 0, &_7$$4, &valueA);
				zephir_check_call_status();
				i++;
			}
			zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 2158);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				i = 0;
				while (1) {
					zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
					if (!(ZEPHIR_GT_LONG(&_12$$5, i))) {
						break;
					}
					ZVAL_LONG(&_13$$6, i);
					ZEPHIR_CALL_METHOD(&valueA, &rowA, "get", &_14, 0, &_13$$6);
					zephir_check_call_status();
					zephir_negate(&valueA);
					ZVAL_LONG(&_13$$6, i);
					ZEPHIR_CALL_METHOD(NULL, &rowA, "set", &_15, 0, &_13$$6, &valueA);
					zephir_check_call_status();
					i++;
				}
				zephir_array_append(&b, &rowA, PH_SEPARATE, "tensor/matrix.zep", 2158);
...
PHP_METHOD(Tensor_Matrix, augmentAbove)
{
	...
	if (UNEXPECTED(_1)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$3, "tensor/matrix.zep", 2176);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	zephir_read_property_cached(&_14, this_ptr, _zephir_prop_1, 16, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &buffer, &_15, &_14);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, augmentBelow)
{
	...
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &buffer, &_15, &_13);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, augmentLeft)
{
	...
	zval *b, b_sub, _0, _2, _3, i, bufferB, bufferA, _10, _4$$3, _5$$3, _7$$3, _14$$4, _15$$4, _17$$4, _18$$4, _19$$4, _20$$4, _21$$4;
	zval *this_ptr = getThis();
	...
	if (_12 <= _13) {
		while (1) {
			...
			zephir_check_call_status();
			zephir_array_append(&c, &_21$$4, PH_SEPARATE, "tensor/matrix.zep", 2230);
		}
	}
...
PHP_METHOD(Tensor_Matrix, augmentRight)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS, _12, _13;
	zval *b, b_sub, _0, _2, _3, i, bufferA, bufferB, _10, _4$$3, _5$$3, _7$$3, _14$$4, _15$$4, _16$$4, _17$$4, _18$$4, _20$$4, _21$$4;
	zval *this_ptr = getThis();
	...
	if (_12 <= _13) {
		while (1) {
			...
			zephir_check_call_status();
			zephir_array_append(&c, &_21$$4, PH_SEPARATE, "tensor/matrix.zep", 2262);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, repeat)
{
	...
	zval bigRows;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval *m_param = NULL, *n_param = NULL, rowA, _18, _0$$3, _1$$3, _2$$3, *_3$$3, _4$$3, *_5$$3, _8$$3, _6$$4, _7$$4, _10$$5, _11$$5, flat$$6, _12$$6, _13$$6, _14$$6, _15$$6, _16$$6, _17$$6;
	zend_long m, n, ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	if (n > 0) {
		...
		zephir_is_iterable(_3$$3, 0, "tensor/matrix.zep", 2286);
		if (Z_TYPE_P(_3$$3) == IS_ARRAY) {
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					zephir_array_append(&bigRows, &_10$$5, PH_SEPARATE, "tensor/matrix.zep", 2284);
			}
		}
		ZEPHIR_INIT_NVAR(&rowA);
	}
	if (zephir_fast_count_int(&bigRows) > 0) {
		...
		zephir_array_fetch_long(&flat$$6, &bigRows, 0, PH_NOISY, "tensor/matrix.zep", 2289);
		ZVAL_LONG(&_13$$6, 1);
		ZEPHIR_CALL_FUNCTION(&_14$$6, "array_slice", NULL, 28, &bigRows, &_13$$6);
		zephir_check_call_status();
		...
		ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &flat$$6, &_16$$6, &_17$$6);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_VAR(&_18);
...
PHP_METHOD(Tensor_Matrix, multiplyMatrix)
{
	...
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &result, &_8, &_9);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, multiplyVector)
{
	...
	zval c;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, _10, _11;
	zval *b, b_sub, _0, _1, i, bHat, _8, _2$$3, _3$$3, _5$$3, _12$$4, _13$$4, _14$$4, _15$$4, _16$$4;
	zval *this_ptr = getThis();
	...
	if (_10 <= _11) {
		while (1) {
			...
			zephir_read_property_cached(&_13$$4, this_ptr, _zephir_prop_2, 14, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_15$$4, this_ptr, _zephir_prop_0, 16, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_NVAR(&_16$$4);
			mul_function(&_16$$4, &i, &_15$$4);
			zephir_read_property_cached(&_15$$4, this_ptr, _zephir_prop_0, 16, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_multiply(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2556);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, divideVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_divide(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2584);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, addVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_add(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2612);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, subtractVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_subtract(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2640);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, powVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_pow(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2668);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, modVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_mod(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2696);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, equalVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_equal(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2725);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, notEqualVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_not_equal(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2753);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, greaterVector)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 3, &_7$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/matrix.zep", 2771);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&c);
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_greater(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2781);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, greaterEqualVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_greater_equal(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2809);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, lessVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_less(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2837);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, lessEqualVector)
{
	...
	if (_10 <= _11) {
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_14$$4, &_13$$4, "slice", NULL, 0, &_16$$4, &_15$$4);
			zephir_check_call_status();
			tensor_less_equal(&_12$$4, &_14$$4, &bHat);
			zephir_array_append(&c, &_12$$4, PH_SEPARATE, "tensor/matrix.zep", 2866);
		}
	}
	ZEPHIR_RETURN_CALL_SELF("quick", NULL, 0, &c);
	zephir_check_call_status();
...
PHP_METHOD(Tensor_Matrix, multiplyColumnVector)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *b, b_sub, _0, _1, i, valueB, _8, *_9, _10, *_11, _19, _2$$3, _3$$3, _5$$3, _14$$4, _15$$4, _16$$4, _17$$4, _18$$4, _21$$5, _22$$5, _23$$5, _24$$5, _25$$5;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 2895);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			...
			zephir_read_property_cached(&_17$$4, this_ptr, _zephir_prop_2, 16, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_NVAR(&_18$$4);
			mul_function(&_18$$4, &i, &_17$$4);
			zephir_read_property_cached(&_17$$4, this_ptr, _zephir_prop_2, 16, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_16$$4, &_15$$4, "slice", NULL, 0, &_18$$4, &_17$$4);
			zephir_check_call_status();
			tensor_multiply_scalar(&_14$$4, &_16$$4, &valueB);
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 2892);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_19, _9, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_19)) {
				break;
			}
			...
			zephir_check_call_status();
				...
				zephir_read_property_cached(&_22$$5, this_ptr, _zephir_prop_1, 14, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_24$$5, this_ptr, _zephir_prop_2, 16, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&_25$$5);
				mul_function(&_25$$5, &i, &_24$$5);
				zephir_read_property_cached(&_24$$5, this_ptr, _zephir_prop_2, 16, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_multiply_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 2892);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, divideColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 2921);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 2918);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_divide_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 2918);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, addColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 2947);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 2944);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_add_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 2944);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, subtractColumnVector)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 3, &_7$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/matrix.zep", 2962);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&c);
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 2973);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 2970);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_subtract_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 2970);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, powColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 2999);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 2996);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_pow_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 2996);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, modColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 3025);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 3022);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_mod_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 3022);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, equalColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 3051);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 3048);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_equal_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 3048);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, notEqualColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 3077);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 3074);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_not_equal_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 3074);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, greaterColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 3103);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 3100);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_greater_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 3100);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, greaterEqualColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 3129);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 3126);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_greater_equal_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 3126);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, lessColumnVector)
{
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 3155);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 3152);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_less_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 3152);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, lessEqualColumnVector)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 3, &_7$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "tensor/matrix.zep", 3170);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&c);
	...
	zephir_is_iterable(_9, 0, "tensor/matrix.zep", 3181);
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_9), _12, _13, _11)
		{
			ZEPHIR_INIT_NVAR(&i);
			...
			zephir_array_append(&c, &_14$$4, PH_SEPARATE, "tensor/matrix.zep", 3178);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _9, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_23$$5, &_22$$5, "slice", NULL, 0, &_25$$5, &_24$$5);
				zephir_check_call_status();
				tensor_less_equal_scalar(&_21$$5, &_23$$5, &valueB);
				zephir_array_append(&c, &_21$$5, PH_SEPARATE, "tensor/matrix.zep", 3178);
		}
	}
	ZEPHIR_INIT_NVAR(&valueB);
	ZEPHIR_INIT_NVAR(&i);
...
PHP_METHOD(Tensor_Matrix, multiplyScalar)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 15, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 16, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_SELF("fromTensorBuffer", NULL, 0, &result, &_2, &_3);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Tensor_Matrix, offsetSet)
{
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(tensor_exceptions_runtimeexception_ce, "Matrix cannot be mutated directly.", "tensor/matrix.zep", 3357);
	return;
}
...
PHP_METHOD(Tensor_Matrix, offsetUnset)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(1, 0, &index);
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(tensor_exceptions_runtimeexception_ce, "Matrix cannot be mutated directly.", "tensor/matrix.zep", 3381);
	return;
}
...
PHP_METHOD(Tensor_Matrix, offsetGet)
{
	...
	if (UNEXPECTED(Z_TYPE_P(index) != IS_LONG)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/matrix.zep", 3395);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (UNEXPECTED(_3)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 3, &_7$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "tensor/matrix.zep", 3400);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_1, 14, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_CE_STATIC(tensor_vector_ce, "fromTensorBuffer", NULL, 0, &_9);
	zephir_check_call_status();
	RETURN_MM();
}
