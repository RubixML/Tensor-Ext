...
static double tensor_row_equal_value(double x, double y)
{
	return x == y ? 1.0 : 0.0;
}

static double tensor_row_not_equal_value(double x, double y)
{
	return x != y ? 1.0 : 0.0;
}

static double tensor_row_greater_value(double x, double y)
{
	return x > y ? 1.0 : 0.0;
}

static double tensor_row_greater_equal_value(double x, double y)
{
	return x >= y ? 1.0 : 0.0;
}

static double tensor_row_less_value(double x, double y)
{
	return x < y ? 1.0 : 0.0;
}

static double tensor_row_less_equal_value(double x, double y)
{
	return x <= y ? 1.0 : 0.0;
}
